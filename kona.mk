...
# Bluetooth ANT Wireless Hal Compilation
...
# Bluetooth ANT Wireless HAL Permissions
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/permissions/com.dsi.ant.antradio_library.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/com.dsi.ant.antradio_library.xml
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/dolby/media/media_codecs_vendor_audio.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_vendor_audio.xml
else
# MiSound (Dirac Only)
