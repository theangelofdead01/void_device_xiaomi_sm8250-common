...
public class AutoHBMService extends Service {
    private static final String HBM_FILE = "/sys/class/drm/card0/card0-DSI-1/disp_param";
    ...
    private void enableHBM(boolean enable) {
        if (enable) {
            FileUtils.writeValue(HBM_FILE, "0x10000");
        } else {
            FileUtils.writeValue(HBM_FILE, "0xF0000");
        }
    }
